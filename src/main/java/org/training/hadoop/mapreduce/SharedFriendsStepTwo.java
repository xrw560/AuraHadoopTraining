...
public class SharedFriendsStepTwo {
    public static class SharedFriendsStepTwoMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class SharedFriendsStepTwoReducer extends Reducer<Text, Text, Text, Text> {
        @Override
